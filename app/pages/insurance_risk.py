...
def main():
    ...
    st.title("🛡️ Insurance Risk Assessment")
    st.markdown("### Specialized analysis for insurance companies")
    ...
    with st.spinner("Performing specialized insurance risk analysis..."):
    ...
    # Display results (similar structure to bank page)
    st.markdown("---")
